...
|----------|--------|------------|
| **4.3** | 12.07.2026 | - Variabeln aktualiseren sich nur noch wenn sich der Datenstand ändert.<br>- Es können zusätzlich Infos zum OEM Aktualierungszeitpunkt für die Variablen eingeblendet werden.<br>- Die Variabeln haben nun zugeornete Positionen im Objektbaum, um die Übersichtlichkeit zu verbessern. |
