...
|----------|--------|------------|
| **4.5** | 25.07.2026 | - Der Webhook wird nun auf Aktualität geprüft und ältere Daten werden verworfen.<br>- In der Vehicle-Instanz kann nun der Powertrain-Filter deaktiviert werden.<br>- Einige Anpassungen zur API V3.|
