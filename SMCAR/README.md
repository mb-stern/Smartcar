...
|----------|--------|------------|
| **3.4** | 21.12.2025 | - Fehlermeldung beim Verbinden des Fahrzeuges behoben.<br>- Fehlermeldung trotz deaktivierten Scopes behoben.<br>- Fehler beim deaktiveren des Scopes nach Scopeprüfung behoben.<br>- Weitere Codeanpassungen. |
