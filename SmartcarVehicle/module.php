    ...
    public function Create(): void
{
        ...
        $form = [
            'elements' => [
                ...
                [
                    ...
                    'items' => [
                        [
                            ...
                            'onChange' => 'SMCARV_RefreshCompatibilityForPowertrainFilter($id, $IgnoreCompatibilityPowertrainFilter);'
                        ],
                        [
                            'type' => 'Label',
                ...
                [
                    ...
                    'caption' => empty($capabilities)
                        ? 'Kompatible Signale / Befehle – keine Treffer'
    ...
    public function RefreshCompatibilityForPowertrainFilter(bool $ignorePowertrainFilter): void
    {
        $this->SendDebug(
        ...
        $capabilities =
            $this->GetCompatibilityCapabilitiesForForm(
    ...
    private function GetCompatibilityCapabilitiesForForm(
        ?bool $ignorePowertrainOverride = null,
    ...
    private function LoadCompatibility(
        bool $forceReload,
        ?bool $ignorePowertrainOverride = null
    ): array
    {
